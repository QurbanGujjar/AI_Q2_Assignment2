...
def function2():
    ...
    x =np.arange(10,37,dtype='f8').reshape(3,3,3)
...
def function17():
    ...
    ans =np.where(np.logical_and(arr%3==0,arr%5==0), 'YES','NO')
    return ans
...
def function19():
    ...
    W = np.arange(1,26,1).reshape(5,5) 
    W = np.transpose(W)
    # print(W)
    b = 5
    output = (X*W)+b
